...
public class DownloadImpl extends AbstractTransfer implements Download {
    ...
    @Deprecated
    public DownloadImpl(String description, TransferProgress transferProgress,
            com.sina.cloudstorage.services.scs.transfer.internal.ProgressListenerChain progressListenerChain, S3Object s3Object, TransferStateChangeListener listener) {
