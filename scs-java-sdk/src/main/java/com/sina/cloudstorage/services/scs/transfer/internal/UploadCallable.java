...
public class UploadCallable implements Callable<UploadResult> {
     ...
     */
    @Deprecated
    public UploadCallable(TransferManager transferManager, ExecutorService threadPool, UploadImpl upload, PutObjectRequest putObjectRequest, com.sina.cloudstorage.services.scs.transfer.internal.ProgressListenerChain progressListenerChain) {
