#SinaStorage SDK[![Build Status](https://travis-ci.org/poorevil/SinaStorage-SDK-Java-v2.png?branch=master)](https://travis-ci.org/poorevil/SinaStorage-SDK-Java-v2)
